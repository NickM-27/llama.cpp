...
struct llm_graph_params {
    ...
    bool allow_reuse(const llm_graph_params & other) const {
        ...
        return
            ...
            cparams.draft_argmax            == other.cparams.draft_argmax            &&
...
public:
    ...
    ggml_tensor * get_draft_ids()   const { return t_draft_ids; }
    ...
    ggml_tensor * t_draft_ids   = nullptr; // [n_outputs] i32 argmax token id per output (dflash draft)
